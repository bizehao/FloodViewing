package com.bzh.floodview.data;
...
import com.bzh.floodview.data.converter.DateConverter;
import com.bzh.floodview.data.dao.FriendsInfoDao;
import com.bzh.floodview.data.dao.MessageInfoDao;
import com.bzh.floodview.data.dao.StationInfoDao;
 ...
 */
@Database(entities = {MessageInfo.class, FriendsInfo.class, StationInfo.class}, version = 1, exportSchema = false)
